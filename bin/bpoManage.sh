...
${G_myName} ${extraInfo} -p privacy="${priv}" -p bpoId="${oneBxoId}" -i bxoGitServerReposDeleteAll
${G_myName} ${extraInfo} -p privacy="${priv}" -p bpoId="${oneBxoId}" -i bxoGitServerKeysDeleteAll
${G_myName} ${extraInfo} -p privacy="${priv}" -p bpoId="${oneBxoId}" -i bxoGitServerFullDelete
...
${G_myName} ${extraInfo} -p bpoId="${oneBxoId}" -i bxoTreeDescendantsList
${G_myName} ${extraInfo} -p bpoId="site" -i bxoTreeDescendantsList
${G_myName} ${extraInfo} -p bpoId="$(usgBpos.sh -i usgBpos_real_indivBxoId_read)" -i bxoTreeDescendantsList
