...
typeset RcsId="$Id: lcaChromeBinsPrep.sh,v 1.1.1.1 2016-06-08 23:49:51 lsipusr Exp $"
# *CopyLeft*
...
"
FILE="
*  /This File/ :: /bisos/core/bsip/bin/lcaChromeBinsPrep.sh 
"
if [ "${loadFiles}" == "" ] ; then
...
${G_myName} ${extraInfo} -i netplanDeactivate
_EOF_
}
...
####+BEGIN: bx:dblock:lsip:binsprep:apt :module "ifupdown"
_CommentBegin_
*  [[elisp:(org-cycle)][| ]]  [[elisp:(blee:ppmm:org-mode-toggle)][Nat]] [[elisp:(beginning-of-buffer)][Top]] [[elisp:(delete-other-windows)][(1)]] || Apt-Pkg       :: ifupdown [[elisp:(org-cycle)][| ]]
_CommentEnd_
item_ifupdown () { distFamilyGenerationHookRun binsPrep_ifupdown; }

binsPrep_ifupdown_DEFAULT_DEFAULT () { binsPrepAptPkgNameSet "ifupdown"; }

####+END:

####+BEGIN: bx:dblock:lsip:binsprep:apt :module "ifupdown-extra"
_CommentBegin_
*  [[elisp:(org-cycle)][| ]]  [[elisp:(blee:ppmm:org-mode-toggle)][Nat]] [[elisp:(beginning-of-buffer)][Top]] [[elisp:(delete-other-windows)][(1)]] || Apt-Pkg       :: ifupdown-extra [[elisp:(org-cycle)][| ]]
_CommentEnd_
item_ifupdown_extra () { distFamilyGenerationHookRun binsPrep_ifupdown_extra; }

binsPrep_ifupdown_extra_DEFAULT_DEFAULT () { binsPrepAptPkgNameSet "ifupdown-extra"; }
...
_CommentBegin_
*      ======[[elisp:(org-cycle)][Fold]]====== Apt-Pkg: google-chrome-stableAddRepo
_CommentEnd_

vis_netplanDeactivate () {
...
item_netplanDeactivate () {
  distFamilyGenerationHookRun binsPrep_netplanDeactivate
}

binsPrep_netplanDeactivate_DEFAULT_DEFAULT () {
    mmaThisPkgName="netplanDeactivate"
