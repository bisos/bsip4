...
** This File: /bisos/core/bsip/bin/airflow-cbs-is-np-sysd.cs
...
sysdUnitsListAirflow = [
    cba_sysd_seed.sysdUnit("airflow-webserver",  "airflow-webserver-sysd.cs"),
    cba_sysd_seed.sysdUnit("airflow-scheduler",  "airflow-scheduler-sysd.cs"),
    cba_sysd_seed.sysdUnit("airflow-triggerer",  "airflow-triggerer-sysd.cs"),
]

cba_sysd_seed.setup(
    sysdUnitsList=sysdUnitsListAirflow,
)
