...
####+BEGIN: bx:dblock:lsip:binsprep:apt :module "google-chrome-stable"
_CommentBegin_
*      ======[[elisp:(org-cycle)][Fold]]====== Apt-Pkg: google-chrome-stable
_CommentEnd_
item_google_chrome_stable () { distFamilyGenerationHookRun binsPrep_google_chrome_stable; }

binsPrep_google_chrome_stable_DEFAULT_DEFAULT () { binsPrepAptPkgNameSet "google-chrome-stable"; }
...
item_google_chrome_stableAddRepo () {
  distFamilyGenerationHookRun binsPrep_google_chrome_stableAddRepo
}

binsPrep_google_chrome_stableAddRepo_DEFAULT_DEFAULT () {
    mmaThisPkgName="google_chrome_stableAddRepo"
