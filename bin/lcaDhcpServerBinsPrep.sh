...
####+BEGIN: bx:dblock:lsip:binsprep:apt :module "isc-dhcp-server"
_CommentBegin_
*  [[elisp:(org-cycle)][| ]]  [[elisp:(blee:ppmm:org-mode-toggle)][Nat]] [[elisp:(beginning-of-buffer)][Top]] [[elisp:(delete-other-windows)][(1)]] || Apt-Pkg       :: isc-dhcp-server [[elisp:(org-cycle)][| ]]
_CommentEnd_
item_isc_dhcp_server () { distFamilyGenerationHookRun binsPrep_isc_dhcp_server; }

binsPrep_isc_dhcp_server_DEFAULT_DEFAULT () { binsPrepAptPkgNameSet "isc-dhcp-server"; }
