...
bisosCurrentsManage.sh  ${extraInfo} -i setParam targetBox 192.168.0.41
$( examplesSeperatorChapter "New Box Realize" )
...
$( examplesSeperatorChapter "Existing Box Activate" )
