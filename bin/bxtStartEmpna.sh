...
"
FILE="
*  /This File/ :: /bisos/git/auth/bxRepos/bisos/bsip4/bin/bxtStartEmpna.sh
"
if [ "${loadFiles}" == "" ] ; then
...
**      ====[[elisp:(org-cycle)][Fold]]==== [[file:/libre/ByStar/InitialTemplates/activeDocs/bxPlatformFacilities/empna/fullUsagePanel-en.org::Xref-Empna][Panel Roadmap Documentation]]
_EOF_
}
