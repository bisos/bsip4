...
function vis_examplesServerConfig {
    ...
    local nichePathOrMyName=$( vis_nichePathOrMyName container )
 cat  << _EOF_
$( examplesSeperatorSection "SERVER CONFIG ACTIONS -- Initial /etc/rc.local" )
${nichePathOrMyName} ${extraInfo} -i rcLocalStdout
${nichePathOrMyName} ${extraInfo} -i rcLocalUpdate
${nichePathOrMyName} ${extraInfo} -f -i rcLocalUpdate
ls -l /etc/rc.local
...
# Machine Generated by ${G_myFullName}
# On ${thisDateTag}

logger "\$0 - rc.local started."

# Your commands come here. This is usually niched.
