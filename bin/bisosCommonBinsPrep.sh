...
####+BEGIN: bx:dblock:lsip:binsprep:apt :module "bc"
_CommentBegin_
*  [[elisp:(org-cycle)][| ]]  [[elisp:(blee:ppmm:org-mode-toggle)][Nat]] [[elisp:(beginning-of-buffer)][Top]] [[elisp:(delete-other-windows)][(1)]] || Apt-Pkg       :: bc [[elisp:(org-cycle)][| ]]
_CommentEnd_
item_bc () { distFamilyGenerationHookRun binsPrep_bc; }

binsPrep_bc_DEFAULT_DEFAULT () { binsPrepAptPkgNameSet "bc"; }
