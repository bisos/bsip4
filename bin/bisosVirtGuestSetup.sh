...
$( examplesSeperatorChapter "BISOS Initializations" )
$( examplesSeperatorSection "Setup Virtalization As Needed" )
${G_myName} ${extraInfo} -i virtGuest_provisionSetup
_EOF_
}
...
function vis_virtGuest_provisionSetup {
    G_funcEntry
    function describeF {  G_funcEntryShow; cat  << _EOF_
Setup Host-virtualization for this host.
_EOF_
    }
    EH_assert [[ $# -eq 0 ]]
