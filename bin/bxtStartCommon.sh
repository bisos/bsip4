...
"
FILE="
*  /This File/ :: /bisos/git/auth/bxRepos/bisos/bsip4/bin/bxtStartCommon.sh
"
if [ "${loadFiles}" == "" ] ; then
...
**      ====[[elisp:(org-cycle)][Fold]]==== [[file:/libre/ByStar/InitialTemplates/activeDocs/blee/bystarContinuum/djangoProc/fullUsagePanel-en.org::Xref-BxWebDjango-SA][Panel Roadmap Documentation]]
_EOF_
}

_CommentBegin_
*      ################      *Imports, Options and Examples Specifications*
_CommentEnd_
...
_CommentBegin_
*      ################      *Interactively Invokable Functions (IIF)*
_CommentEnd_
...
_CommentBegin_
*      ################      *Common/Generic Facilities -- Library Candidates*
_CommentEnd_

_CommentBegin_
*      ################      *Unused Facilities -- Temporary Junk Yard*
_CommentEnd_
