...
bisosCurrentsManage.sh ${extraInfo} -i currentsGetThenShow
...
$( examplesSeperatorChapter "Site Defaults Set" )
${G_myName} ${extraInfo} -i fullUpdate
${G_myName} ${extraInfo} -i default_gitServer
_EOF_
}
...
function vis_fullUpdate {
  lpDo vis_default_gitServer
}


function vis_default_gitServer {
    G_funcEntry
