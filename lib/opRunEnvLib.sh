...
#
# RCS Revision: $Id: opRunEnvLib.sh,v 1.1.1.1 2016-06-08 23:49:51 lsipusr Exp $
#
...
opRunHostFamily=${opRunHostFamily}
opRunHostFamilyTag=${opRunHostFamilyTag}
...
function opRunEnvSet {
  ...
  do
    ...
    elif [ "opRunHostFamily" == ${leftSide} ] ; then
      opRunHostFamily=${rightSide}
    elif [ "opRunHostFamilyTag" == ${leftSide} ] ; then
      opRunHostFamilyTag=${rightSide}
    else
